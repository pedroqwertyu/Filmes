    ...
    <>
      ...
      <Row>
        {props.lista.map(item => (
          <Col md={2} className="mb-3" key={item.id}>
            <ExibirFoto rota={props.rota} id={item.id} foto={item[props.foto]} />
          </Col>
        ))}
      </Row>
    </>
